                    ...
                    <table class="table table-hover table-striped table-warning">
                        ...
                        <tbody>
							...
							<tr>
								...
								<td><a class="btn btn-outline-primary" href="<?php echo "editar.php?N_Parte=" . $registro['CODIGO']?>">Editar</a></td>
								<td><a class="btn btn-outline-primary" href="<?php echo "eliminar.php?N_Parte=" . $registro['CODIGO']?>">Eliminar</a></td>
							</tr>
							<?php } ?>                           
                        </tbody>
                    </table>
